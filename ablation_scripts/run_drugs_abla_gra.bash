...
python train_4d_moe.py --seed 8888 --dataset Drugs --target ea --num_epochs 1000\
 --modeldss:conf_encoder ViSNet --modeldss:topo_encoder GIN --batch_size 32 \
 --port $PORT --optimizer AdamW --scheduler LambdaLR --learning_rate 0.0002 \
 --weight_decay 0.001 --gpus 0 --patience 400 --gig True --sag True --upc True\
 --num_experts 8 --num_activated 2 --upcycling_epochs 50 --gumbel_tau 0.1 --z_beta 0.001 \
 --additional_notes sampled_drugs_train_4d_moe_gig_vec_norm \
...
python train_4d_moe.py --seed 8888 --dataset Drugs --target ea --num_epochs 1000\
 ...
 --port $PORT --optimizer AdamW --scheduler LambdaLR --learning_rate 0.0002 \
 --weight_decay 0.001 --gpus 0 --patience 400 --gig True --sag True --upc True\
 --num_experts 8 --num_activated 4 --upcycling_epochs 50 --gumbel_tau 0.1 --z_beta 0.001 \
 --additional_notes sampled_drugs_train_4d_moe_gig_vec_norm \
 --wandb_project MoE-Drugs-Ablation
...
python train_4d_moe.py --seed 8888 --dataset Drugs --target ea --num_epochs 1000\
 ...
 --port $PORT --optimizer AdamW --scheduler LambdaLR --learning_rate 0.0002 \
 --weight_decay 0.001 --gpus 0 --patience 400 --gig True --sag True --upc True\
 --num_experts 32 --num_activated 8 --upcycling_epochs 50 --gumbel_tau 0.1 --z_beta 0.001 \
 --additional_notes sampled_drugs_train_4d_moe_gig_vec_norm \
 --wandb_project MoE-Drugs-Ablation
