...
class GPSModel(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, pe_dim, num_layers):
        super().__init__()
        self.atom_encoder = AtomEncoder(emb_dim=hidden_dim-pe_dim)
        self.bond_encoder = BondEncoder(emb_dim=hidden_dim)
        self.node_emb = Embedding(28, hidden_dim - pe_dim)
    ...
    def preprocess(self, data_list):
        ...
        x, pe, edge_index, edge_attr, batch = batch.x, batch.pe, batch.edge_index, batch.edge_attr, batch.batch
